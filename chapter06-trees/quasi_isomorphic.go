...
func QuasiIsomorphic(root1, root2 *BinaryTreeNode) bool {
	...
	return (QuasiIsomorphic(root1.left, root2.left) && QuasiIsomorphic(root1.right, root2.right)) || (QuasiIsomorphic(root1.right, root2.left) && QuasiIsomorphic(root1.left, root2.right))
}
...
func main() {
	...
	t2 := NewBinaryTree(10, 1)
	fmt.Println(BinaryTreePaths(t2))

	fmt.Println(QuasiIsomorphic(t1, t2))
